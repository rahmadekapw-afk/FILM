    ...
    <div class="min-h-screen flex items-center justify-center p-6 relative overflow-hidden">
        <div class="relative z-10 w-full max-w-[420px]">
                ...
                <div class="relative z-10">
                    <div class="text-center mb-10">
                        ...
                        <div class="w-24 h-24 bg-gradient-to-tr from-brand-primary to-brand-secondary rounded-full mx-auto mb-8 flex items-center justify-center shadow-[0_0_30px_rgba(229,9,20,0.4)] relative">
                            <div class="absolute inset-0 rounded-full animate-ping bg-brand-primary/20"></div>
                            <i data-lucide="user" class="w-12 h-12 text-white"></i>
                        </div>
                        <h2 class="text-3xl font-black tracking-[0.2em] mb-3 text-white">LOGIN</h2>
                    ...
                    <form method="POST" action="{{ url('/login') }}" class="space-y-6">
                        ...
                        >
                            ...
                            <span class="uppercase tracking-[0.3em] ml-2">LOGIN</span>
                            <i data-lucide="arrow-right" class="w-5 h-5 group-hover:translate-x-2 transition-transform duration-300"></i>
                        </button>
                    </form>

                    <div class="mt-12 text-center space-y-4">
                        <p class="text-neutral-600 text-[10px] font-bold uppercase tracking-widest leading-relaxed">
                            Belum punya akun? <a href="{{ route('register') }}" class="text-brand-primary hover:underline">Daftar sekarang</a>
                        </p>
                        <div class="pt-4 border-t border-neutral-800">
                            <a href="{{ url('/') }}" class="text-neutral-500 hover:text-brand-primary text-xs font-black uppercase tracking-widest transition-colors flex items-center justify-center gap-2">
            ...
            <div class="mt-12 flex justify-center">
                <div class="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-neutral-900/50 backdrop-blur-md border border-neutral-800 text-neutral-600 text-[9px] font-black uppercase tracking-[0.25em] shadow-2xl">
                    <div class="w-1.5 h-1.5 rounded-full bg-brand-primary shadow-[0_0_8px_rgba(229,9,20,0.6)]"></div>
