        ...
        <nav className={`fixed w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-bg-dark/95 backdrop-blur-md border-b border-white/10 py-3' : 'bg-transparent py-5'}`}>
            <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button className="hidden sm:flex items-center gap-2 bg-brand-primary hover:bg-brand-secondary text-white px-4 py-1.5 rounded-full text-sm font-semibold transition-all">
            ...
            {isMenuOpen && (
                <div className="md:hidden bg-bg-dark border-b border-white/10 px-4 py-6 space-y-4 animate-in fade-in slide-in-from-top-4">
                    ...
                    <button className="w-full bg-brand-primary hover:bg-brand-secondary text-white py-3 rounded-xl font-bold transition-all">
                        Sign In
                    </button>
                </div>
            )}
